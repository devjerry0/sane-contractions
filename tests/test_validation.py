...
def test_validate_string_param_invalid():
...
def test_validate_dict_param_valid():
    validate_dict_param({"key": "value"}, "param")


def test_validate_dict_param_invalid():
...
def test_validate_data_type_valid_dict():
    validate_data_type({"key": "value"}, dict, "source.json")


def test_validate_data_type_valid_list():
